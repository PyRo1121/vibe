	...
	>
		...
		<div class="mt-6 grid gap-4 md:grid-cols-2">
			...
			<div class="rounded-xl border border-zinc-700 bg-zinc-950/80 p-5">
				...
				<p class="text-xs font-semibold tracking-wider text-zinc-500 uppercase">Free (you have this)</p>
				...
				<ul class="mt-3 space-y-2 text-sm text-zinc-400">
					...
					<li>✓ 1 sample Cursor prompt{#if offer.hasSample}{/if}</li>
			...
			<div class="rounded-xl border border-sky-500/40 bg-sky-500/5 p-5">
				...
				<p class="text-xs font-semibold tracking-wider text-sky-400 uppercase">$9 unlock (fix loop)</p>
				...
				<ul class="mt-3 space-y-2 text-sm text-zinc-200">
					...
					<li>✓ <strong class="text-white">1 master paste</strong> — fixes all issues in priority order</li>
		...
		<div class="mt-6 rounded-xl border border-zinc-800 bg-zinc-950 p-4">
			...
			<div class="relative overflow-hidden rounded-lg bg-zinc-900 p-3 font-mono text-xs leading-relaxed text-zinc-500">
