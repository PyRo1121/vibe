...
**Test deployment:** [lint.latham.cloud](https://lint.latham.cloud)  
...
- **CI gate** — zero-install script (`/gate-remote.mjs`). See [/developers](https://lint.latham.cloud/developers).
